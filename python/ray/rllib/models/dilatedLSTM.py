...
def dynamic_rnn(cell, inputs, dilatation_rate=0, sequence_length=None, initial_state=None,
...
def _dynamic_rnn_loop(cell,
    ...
    output_ta = tuple([0 for _ in range(time_steps)]
                          for i in range(len(flat_output_size)))
    input_ta = flat_input

    states = [state] + [state for _ in range(dilatation_rate - 1)]
